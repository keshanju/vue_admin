...
import { DxDataGrid, DxForm,DxTreeList } from 'devextreme-vue';
...
@Component({
    components: {
        DxDataGrid, DxForm,DxTreeList
    }
})
export default class Home extends BaseVue {

    protected DxTreeListKey1: string = "DxTreeListKey1";
    protected dxTreeList1: DevExpress.ui.dxTreeList;
    ...
    private initComponents() {
        this.dxTreeList1 = this.getDxInstanceByKey(this.DxTreeListKey1);
        ...
        let treeListData = $.map(tasks, function(task:any, _) {
        ...
        let cols: DevExpress.ui.dxDataGridColumn[] = [
            {
                ...
                cellTemplate: function(container, options) {
                    let currentEmployee = options.data.Task_Assigned_Employee;
                    if(currentEmployee) {
        ...
        this.dxTreeList1.option(options);
    }
}