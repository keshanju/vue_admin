                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="nav-header">
                        <div style="text-align: center;height: 65px;" class="dropdown profile-element">
                            <img class="img-circle" src="/static/avatar.png"
                                 style="width:65px;float: left;margin-right: 10px;">
                            <a style="float: left;margin-top: 10px;" data-toggle="dropdown"
                               class="dropdown-toggle clear" href="javascript: void(0);">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a @click="href_link('/dashboard')" class="J_menuItem"
                                   :class="{link_active:$route.path=='/dashboard'}" data-index="0">首页</a>
                            </li>
                        </ul>
                    </li>
                    <!--默认的一级按钮列表-->
                    <li v-for="(item,index) in menuItems" :key="item.id">
                        ...
                        <ul class="nav nav-second-level">
                            <li v-for="item2 in item.items" :key="item2.id">
                                <a @click="href_link('/'+item2.href)" class="J_menuItem"
                                   :class="{link_active:$route.path=='/'+item2.href}" :data-index="item2.id">{{item2.text}}</a>
                            </li>
                        </ul>
                    </li>
                </ul>
